...
var iAmMad_req_n=2
iAmMad         [13,39]  [13,39]    [13,39]  [13]  [13]  [13,1,39]       [13,1,39]      any
iAmMad_weight  any      [0.1,0.9]  any      any   any   [0.1,0.4,0.5]   [0.1,0.4,0.5]  any
iAmMad_req_n   2        1          >2       1     >1    1               2              0
req            [13,39]  most 39    []       13    []    most 39         most [1,39]    []
* if iAmMad_req_n==2, then req may [39,39] or [1,1], etc.
...
function process_lddgo(){
  function setRan(generateResult,_req){
      ...
      //console.log(temp,numbers,typeof(numbers),text,typeof(text))
      //console.log(numbers,toNoramlArray(numbers))
  ...
  if(!(played_lddgo>max_play_times)){
    //console.log(!(played_lddgo>max_play_times),played_lddgo)
  }
  if(iAmMad&&(!(played_lddgo>max_play_times))){
    //console.log(req,iAmMad_req_n)
